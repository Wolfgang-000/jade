const products = [
  ...
  },
  {
    ...
    sell:'采购端优先说明库存、起订量、批号与效期，减少询价往返。',
    tags:['OTC','现货'], specs:['20ml']
  },
  {
  ...
  },
  {
    ...
    sell:'营养健康品按采购价、库存与起订量展示，减少面向消费者的促销噪音。',
    tags:['营养','补货'], specs:['60片','120片']
  },
  {
    ...
    sell:'适合门店日常护理类补货，正式供货条件以业务后台为准。',
    tags:['护理','组合装'], specs:['家庭版']
  },
  {
    ...
    sell:'仅用于B端资质采购流程演示；正式业务需校验客户经营资质、经营范围及平台规则。',
    tags:['Rx','资质采购'], specs:['示例规格']
  }
];
...
const activities = [
  {id:'a1',title:'秋冬备货季',subtitle:'围绕感冒呼吸、咽喉与儿童用药提前组织门店库存',cta:'查看备货专区',image:'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&w=1400&q=80',status:'live'},
  ...
  {id:'a3',title:'重点品种补货',subtitle:'常购、现货与阶段性重点供应品种',cta:'立即补货',image:'https://images.unsplash.com/photo-1580281657527-47f249e8f4df?auto=format&fit=crop&w=1400&q=80',status:'upcoming'}
];
